...
public class MachineTest_Test02 {
	...
	public static void Order() throws IOException, InterruptedException {
		...
		driver.findElement(By.className("MuiOutlinedInput-input")).sendKeys("C:\\Users\\pampa\\automation\\MachineTestAssignment\\src\\test\\resources\\Test_Data\\demo-data.xlsx");
